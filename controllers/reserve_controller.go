...
type ReservationController interface {
	...
	GetAllReservation(writer http.ResponseWriter, request *http.Request, params httprouter.Params)
}
...
func (controller *ReservationControllerImpl) GetAllReservation(writer http.ResponseWriter, request *http.Request, params httprouter.Params) {
	reservationResponse := controller.ReserveService.GetAllReservation(request.Context())
